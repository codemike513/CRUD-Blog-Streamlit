    ...
    if choice == "Home":
        ...
        for i in result:
            ...
            st.markdown(title_temp.format(b_title, b_author,
                        b_article, b_postdate), unsafe_allow_html=True)
        ...
        for i in post_result:
            ...
            st.markdown(head_message_temp.format(
                b_title, b_author, b_postdate), unsafe_allow_html=True)
        ...
        if st.checkbox("BarH Plot"):
            ...
            barh_plot = new_df.plot.barh(
                x='Author', y='Length', figsize=(20, 12))
            plt.xlabel("Length", fontsize=50)
            plt.ylabel("Author", fontsize=50)
